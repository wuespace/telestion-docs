...
messages, update cross-dependencies of the different packages and publish all
packages to npm while simultaneously creating a release on GitHub and updating
the `CHANGELOG.md`.
