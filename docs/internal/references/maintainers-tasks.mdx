...
Otherwise, this project will get into a lot of legal trouble.
...
Having a conventional commit for every change enables our tools to automatically generate the
release notes and the next released version. Thus, if a branch has
