...
description: Find out which conventional commit type you need to use.
---
...
:::tip More than one commit types
...
<table id="table_fhj_gnv_vnb">
	<thead>
		<tr>
			...
			<td>Smallest Required Version Bump</td>
			<td>Description</td>
		</tr>
	</thead>
	<tbody>
...
<Reference to="/internal/concepts/conventional-commits">
