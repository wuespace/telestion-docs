...
Following the project's branch naming convention helps to keep things consistent and also
...
If you don't want to read through this page, you can use the interactive
...
(the changes it attempts to make).
...
The CLI needs an extensive restructuring. This is too big to discuss
in a single issue and instead covers more than one issue.
