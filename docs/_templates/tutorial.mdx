...
Within your class declaration, add a new field called `engine`, which has
...
Adding the field for the car's max speed (which is an integer) works the
same way:
...
In the following tutorials, you'll learn how to create an object of your `Car` class.
