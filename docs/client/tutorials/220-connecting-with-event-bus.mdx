...
In the following tutorial, you'll learn how you can add adding configuration
options to your widget to allow Ground Station operators (that is, your users)
to re-configure your widget's behavior on the fly.
