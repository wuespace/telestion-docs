...
We recommend that you familiarize yourself with both the Spectrum Design system
in general as well as the React Spectrum implementation using Adobe's resources:
