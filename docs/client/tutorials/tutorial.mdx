...
The result is a project-structure to begin to customize.

## Step 1: Installing `tc-cli`

Install the tc-cli by copying the following code into the terminal:
...
Open the terminal where you want to generate the project and execute:
...
This generates a foulder that contains a ready to use client project and installs all necessary dependencies.
...
Run the client by navigating into your foulder and use the following:
...
Now that we've generated our client project, we'll configure and extend our client in the next tutorials.
