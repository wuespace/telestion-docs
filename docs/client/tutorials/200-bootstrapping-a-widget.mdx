...
description:
  Many Telestion Client projects need their custom widgets. Thankfully, the
  Telestion tooling makes it straightforward to generate new widgets. Learn how
...
have a Telestion Client project that you want to work with.
...
widget. However, when you look at your dashboard again, your widget isn't
visible yet.

## Step 2: Add the widget to your dashboard

To add the new widget to your dashboard, you must modify the dashboard
...
`widgetName` property with our widget name:
...
headline _myFirstWidget widget_ looks a bit hideous :wink:.

However, since the React component within your `widget.tsx` defines your UI, you
can create whatever UI you want.
...
In the following tutorials, we'll take a look at how you can use the React
Spectrum library to build widgets that are consistent with the other parts of
the UI, interact with our event bus abstractions to interact with the backend,
and using our simple way of adding user configuration options to your widget.
