...
Chromium in a specific version), which makes it easier to develop.

Furthermore, distribution as a desktop app allows you to add native features
(like desktop notifications) to your Client without much effort.
