...
exposes APIs that enable applications to access native functionality such as the
file system and much more.

## The command-line interface

To run a JS file with Node, simply run `node [JS file location]` in your command
line. It's also possible to open an interactive REPL (Read-eval-print loop) by
just running `node` without any arguments.
...
<Reference to="/client/concepts/npm">npm: A package manager for NodeJS applications</Reference>
