---
title: Prerequisites
description: Prerequisites for developing Telestion Clients
---
...
An overview of what you need to develop a Telestion Client.
...
Any editor or IDE works, but _JetBrains WebStorm_ and _Visual Studio Code_ work well with the ecosystem.
