...
<Grid>
	<Reference to="/application/tutorials/starting-a-new-project/">Starting a new project</Reference>
	<Reference to="/application/tutorials/writing-a-verticle/">Writing a Verticle</Reference>
