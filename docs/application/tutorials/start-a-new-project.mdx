...
First, log in into GitHub with your user account.
...
Please select suitable user/group and give the repository a meaningful name.
...
The template ships with a GitHub action which does the Initialzation steps for you.
