...
Deploying your Application is an important part in the Project livecycle.
Learn how you deploy your Application on GitHub and manually.
...
<Reference to="#using-github">
  Deploy using GitHub
</Reference>

<Reference to="#manually">
  Deploy manually
</Reference>
...
:::tip Modify `docker-compose.yml`

The packaged `docker-compose.yml` is a copy of the `application/docker-compose.prod.yml` configuration file.

In this file you can define which Docker images run on your production system, which ports are exposed, etc.
...
You can configure the deployed Telestion Project with the configuration files in the `conf` folder
