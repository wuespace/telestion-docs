...
You can also provide the information via command line parameters.
Run `./scripts/initializate.sh --help` for more information.
...
If you have a remote repository at your hand, you can add it as the default remote
of the new Telestion Project:
