...
In this tutorial, we start a new Telestion Project based on the provided
template.

:::info Prerequisites

To complete this tutorial, you should be familiar with the functionality of Git
and the usage of GitHub templates as well as the GitHub web interface.
...
Next, select your repository's visibility. When you are satisfied with your
...
Next, initialize the Telestion project. Our template already has a GitHub Action
