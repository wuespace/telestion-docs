...
All in all, it is the part doing the necessary Ground Station Magic to enable
Telestion to work.

Typically, Telestion projects use a mix of pre-defined and custom so-called
_Verticles_ that, together, create the full Ground Station functionality.

The following sections will teach you everything you need to know to develop for
the _Application_ within the Telestion ecosystem.
